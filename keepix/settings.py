...
LOGIN_REDIRECT_URL = 'catalog:object_list'
...
MAX_PHOTO_SIZE_MB = 7
MAX_PDF_SIZE_MB = 25
PHOTO_PREVIEW_MAX_PX = 400

APP_PORT = os.environ.get('APP_PORT', '80').strip()
KEEPIX_PUBLIC_BASE_URL = os.environ.get('KEEPIX_PUBLIC_BASE_URL', '').strip().rstrip('/')


def build_object_public_url(code: str) -> str:
    base = KEEPIX_PUBLIC_BASE_URL or _default_public_base_url()
    return f'{base}/objects/{code}/'
